...
option = {
    ...
    series: [{
        name: '外卖',
        type: 'bar',
        data: [122, 143, 133, 159, 175, 152, 136, 144, 156],
        barWidth:'20%', //柱子宽度
       // barGap: 1, //柱子之间间距
        itemStyle: {
            normal: {
        ...
        name: '到店',
        type: 'bar',
		data: [33, 45, 113, 162, 95, 65, 166, 24, 38],
		barWidth:'20%',
       // barGap: 1,
        itemStyle: {
            normal: {
    ...
    series: [
        {
			...
			center: ['40%', '50%'],
            radius: ['40%', '50%'],
			color: ['#62c98d', '#2f89cf', '#4cb9cf', '#e0c828','#eb295b'],	
            label: {show:false},
			labelLine: {show:false},
            data:[
                {value:10, name:'咖啡类'},
